...
이 약관은 도담이 제공하는 서비스의 이용 조건과 절차, 회원과 회사의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.

제2조 (정의)
"서비스"란 도담이 제공하는 공연 티켓 응모 및 관련 서비스 일체를 말합니다.
...
const String _placeholderPrivacy = '''도담은 이용자의 개인정보를 소중히 다룹니다.
...
동의를 거부하셔도 도담 서비스를 이용하시는 데에는 문제가 없습니다.
